...
import io.petros.reviews.data.BuildConfig
import io.petros.reviews.data.R
import io.petros.reviews.data.getLong
import io.petros.reviews.data.network.WebService
import io.petros.reviews.data.network.interceptor.HeaderInterceptor
import io.petros.reviews.data.network.rest.RestApi
import io.petros.reviews.data.network.rest.RestClient
...
class NetworkModule {
    ...
    fun provideRetrofit(
        ...
        return Retrofit.Builder()
            .baseUrl(context.getString(R.string.rest_getyourguide_url))
